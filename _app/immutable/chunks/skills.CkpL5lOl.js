import{A as e}from"./assets.DJuPUw-N.js";const g=(n,...o)=>{const i={...n};return Object.keys(i).forEach(r=>{o.includes(r)&&delete i[r]}),i},p=`Svelte is a free and open-source component-based front-end software framework, and language created by Rich Harris and maintained by the Svelte core team members.  
<br>
...
<br>
&emsp;— rust-lang.org  
<br>`,t=n=>n,w=[t({name:"Main Programming Languages",slug:"main-pro-lang"}),t({name:"Programming Languages",slug:"pro-lang"}),t({name:"Engines",slug:"engine"}),t({name:"Libraries",slug:"library"}),t({name:"Markup, Style, & Framework",slug:"markup-style-framework"}),t({name:"Databases",slug:"db"}),t({name:"ORMs",slug:"orm"}),t({name:"DevOps",slug:"devops"}),t({name:"Testing",slug:"testing"}),t({name:"Dev Tools",slug:"devtools"}),t({name:"Design",slug:"design"}),t({name:"Soft Skills",slug:"soft-skills"})],a=n=>{const o=g(n,"category");return n.category&&(o.category=w.find(i=>i.slug===n.category)),o},C=(...n)=>l.filter(o=>n.length===0?!0:n.includes(o.slug)),T=n=>{const o=[],i=[];return l.forEach(r=>{if(n.trim()&&!r.name.toLowerCase().includes(n.trim().toLowerCase()))return;if(!r.category){i.push(r);return}let s=o.find(d=>{var c;return d.category.slug===((c=r.category)==null?void 0:c.slug)});s||(s={items:[],category:r.category},o.push(s)),s.items.push(r)}),i.length!==0&&o.push({category:{name:"Others",slug:"others"},items:i}),o},S="Skills",l=[a({slug:"python",color:"yellow",description:m,logo:e.Python,name:"Python",category:"main-pro-lang"}),a({slug:"cpp",color:"dodgerblue",description:y,logo:e.Cpp,name:"C++",category:"main-pro-lang"}),a({slug:"c",color:"dodgerblue",description:f,logo:e.C,name:"C",category:"pro-lang"}),a({slug:"csharp",color:"purple",description:`The C# language is the most popular language for the .NET platform, a free, cross-platform, open source development environment.
			...
			— typescriptlang.org`,logo:e.TypeScript,name:"TypeScript",category:"pro-lang"}),a({slug:"js",color:"yellow",description:b,logo:e.JavaScript,name:"JavaScript",category:"pro-lang"}),a({slug:"java",color:"#4949f1",description:`Java is a widely-used programming language for coding web applications. It has been a popular choice among developers for over two decades,
			...
			big data applications and server-side technologies. — Amazon Web Services`,logo:e.Java,name:"Java",category:"pro-lang"}),a({slug:"rust",color:"sienna",description:v,logo:e.Rust,name:"Rust",category:"pro-lang"}),a({slug:"unreal",color:"black",description:`Unreal Engine (UE) is a 3D computer graphics game engine developed by Epic Games, first showcased in the 1998 first-person shooter video game Unreal.
