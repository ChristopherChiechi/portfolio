...
const items = [
	...
	defineSkill({
		...
		color: '#4949f1',
		description:
			`Java is a widely-used programming language for coding web applications. It has been a popular choice among developers for over two decades,
			...
			big data applications and server-side technologies. — Amazon Web Services`,
		logo: Assets.Java,
		name: 'Java',
		category: 'pro-lang'
	}),
